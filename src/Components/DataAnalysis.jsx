...
import { fileSetting, startFn, chart2png, previewThead, table2csv, errorHandler } from "js/common";
    ...
    const analysis = async (e) => {
        if (startFn(e, startParamState)) {
            ...
            if (typeof result === "object") {
                if (result.data === null) return alert("업로드한 파일을 확인해 주세요.");
                //& 상관분석
            ...
            <div>
                ...
                <div className="content-wrap">
                    ...
                    <div>
                        ...
                        <button onClick={(e) => analysis(e.target)} className={tab === "상관분석" ? "active" : ""}>
                            상관분석
                        </button>
                        <button onClick={(e) => analysis(e.target)} className={tab === "교차분석" ? "active" : ""}>
                            교차분석
                        </button>
                        <button onClick={(e) => analysis(e.target)} className={tab === "CART분석" ? "active" : ""}>
                            CART분석
                        </button>
                        <br />
                                ...
                                }
                                {
                                    ...
                                    tab === "교차분석" && (
                                        <div className="wrap">
                                            ...
                                            <div className="downloadBtnWrap">
                                                <button onClick={() => table2csv(fileInfo, tab)} className="exportBtn">
                                                    다운로드
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    tab === "CART분석" && (
                                        <div className="row">
                                            <div className="wrap">
                                                ...
                                                <div className="downloadBtnWrap">
                                                    <button onClick={() => chart2png(fileInfo, tab)} className="exportBtn">
                                                        차트 이미지 다운로드
                                                    </button>
                                                </div>
                                            </div>
